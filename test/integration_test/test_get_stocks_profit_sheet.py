...
def _call_get_stocks_profit_sheet(year: int, stock_type: constant.StockType, quarter: int):
    for i in range(5):
        try:
            return get("stocks_profit_sheet", year=year, stock_type=stock_type.value, quarter=quarter, timeout=60)
